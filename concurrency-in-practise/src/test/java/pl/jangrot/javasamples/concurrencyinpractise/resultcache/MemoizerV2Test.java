...
public class MemoizerV2Test {
    ...
    private MemoizerV2<Integer, String> underTest;

    @Before
    public void setUp() {
        underTest = new MemoizerV2<>(c);
    }

    @Ignore // This test fails as computation is run more than one time for single input
    @Test
