...
public class MemoizerV3Test {
    ...
    private MemoizerV3<Integer, String> underTest;

    @Before
    public void setUp() {
        underTest = new MemoizerV3<>(c);
    }
    ...
    @Ignore // This test should fail as it's possible that two threads will run computation for the same value
    @Test
